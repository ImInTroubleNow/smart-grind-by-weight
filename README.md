...
- **User-friendly interface** with 6 profiles: 2/4/6/8/10 Cups, plus a Custom profile — or switch to an **Espresso** profile style (Single/Double/Custom) in Menu → Modes → Profile Mode, each style keeping its own independently-saved weights/times
