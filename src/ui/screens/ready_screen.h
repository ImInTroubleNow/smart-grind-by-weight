...
private:
    ...
    lv_obj_t* name_icon_labels[USER_PROFILE_COUNT];
...
public:
    ...
    void set_active_tab(int tab, GrindMode mode);
    void update_active_dot(int tab, GrindMode mode);
    void update_top_caption(ProfileStyle style, GrindMode mode);
...
private:
    ...
    void update_mode_icon(int index, GrindMode mode);
};
