...
public:
    ...
    enum class EventType {
        ...
        PROFILE_STYLE_SELECT_DRIP,
        PROFILE_STYLE_SELECT_ESPRESSO,
        GRIND_MODE_SELECT_WEIGHT_TIME,
        GRIND_MODE_SELECT_TIME_ONLY,
        AUTO_START_TOGGLE,
        AUTO_RETURN_TOGGLE,
        ...
        AUTO_DIM_TIMEOUT_SLIDER,
        AUTO_DIM_TIMEOUT_SLIDER_RELEASED,
        CAL_OK,
        CAL_CANCEL,
        CAL_PLUS,
        CAL_MINUS,
